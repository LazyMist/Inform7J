...
public record MappedCollection<K,V>(Collection<? extends K> backing, Function<? super K,? extends V> mapping) implements Collection<V> {
	public <E> MappedCollection<K,E> map(Function<? super V,? extends E> map2) {
		return new MappedCollection<>(backing, mapping.andThen(map2));
	}
