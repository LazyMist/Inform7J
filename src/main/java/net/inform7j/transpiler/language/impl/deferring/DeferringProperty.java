...
public class DeferringProperty extends DeferringImpl implements IProperty {
	...
	public static final String CAPTURE_OWNER = "owner", CAPTURE_TYPE = "type", CAPTURE_NAME = "name";
	public static final List<Parser<DeferringProperty>> PARSERS = Collections.unmodifiableList(Arrays.asList(
			new Parser<>(
	...
	public final TokenString OWNER,NAME,TYPE;
